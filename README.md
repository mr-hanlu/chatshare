...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)[![Version](https://img.shields.io/badge/Version-0.1.0-brightgreen.svg)]()
<!-- [![GreasyFork](https://img.shields.io/badge/GreasyFork-一键安装-red.svg)](这里未来放GreasyFork链接) -->
...
2. 点击下方链接一键安装脚本：
   * 👉 **[通过 GreasyFork 安装](#)** *(注：待发布后替换链接)*
   * 👉 **[通过 GitHub Raw 安装](https://raw.githubusercontent.com/mr-hanlu/chatshare/main/chatshare.user.js)**
