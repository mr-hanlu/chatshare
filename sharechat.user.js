// ==UserScript==
// @name         ShareChat - AI 对话下载器
// @namespace    https://github.com/mr-hanlu/sharechat
// @version      0.1.0
...
(function () {
    ...
    if (document.getElementById('sharechat-extractor-host')) return;
    ...
    host.id = 'sharechat-extractor-host';
    ...
    btnMd.addEventListener('click', () => {
        ...
        td.addRule('math', {
            filter: function (node) { return node.nodeName === 'SPAN' && node.className === 'sharechat-math'; },
    ...
    btnImg.addEventListener('click', async () => {
        ...
        try {
            ...
            console.error('[ShareChat Error]:', e);
    ...
    function downloadFile(content, ext, type, isDataUrl = false) {
        ...
        a.download = `ShareChat_${new Date().toISOString().slice(0, 19).replace(/[T:]/g, '-')}.${ext}`;
    ...
    console.log('[ShareChat Extractor] 挂载成功');
})();